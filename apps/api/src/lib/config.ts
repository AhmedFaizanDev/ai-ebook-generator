...
export const UNIT_COUNT = DEBUG_MODE ? 2 : 10;
export const SUBTOPICS_PER_UNIT = DEBUG_MODE ? 2 : 6;
export const CAPSTONE_COUNT = DEBUG_MODE ? 1 : 1;
export const CASE_STUDY_COUNT = DEBUG_MODE ? 1 : 1;
